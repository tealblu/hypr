...
# Remove existing wallpaper and preload lines
sed -i '/^wallpaper = /d' "$CONFIG"
sed -i '/^preload = /d' "$CONFIG"

# Add new entries
echo "preload = $DIR/background.png" >> "$CONFIG"
echo "wallpaper = , $DIR/background.png" >> "$CONFIG"
